...
INSERT INTO "new_Document" ("afterDiscountSatang", "bahtText", "createdAt", "custAddress", "custBranchCode", "custBranchType", "custContactPerson", "custEmail", "custName", "custPhone", "custTaxId", "customerId", "discountSatang", "docDiscountType", "docDiscountValue", "docNumber", "docType", "grandTotalSatang", "id", "issueDate", "notes", "payableSatang", "status", "subtotalSatang", "templateVersionId", "updatedAt", "vatMode", "vatRateBp", "vatSatang", "whtRateBp", "whtSatang") SELECT "afterDiscountSatang", "bahtText", "createdAt", "custAddress", "custBranchCode", "custBranchType", "custContactPerson", "custEmail", "custName", "custPhone", "custTaxId", "customerId", "discountSatang", "docDiscountType", "docDiscountValue", "docNumber", "docType", "grandTotalSatang", "id", "issueDate", "notes", "payableSatang", "status", "subtotalSatang", "templateVersionId", "updatedAt", "vatMode", "vatRateBp", "vatSatang", "whtRateBp", "whtSatang" FROM "Document";
DROP TABLE "Document";
