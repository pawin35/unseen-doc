# Flow Clone — ระบบออกเอกสารธุรกิจที่ทุกคนเข้าถึงได้

โคลนของ FlowAccount ที่เน้นการเข้าถึงด้วยโปรแกรมอ่านหน้าจอ (screen reader) ครอบคลุม
...
- ข้อมูลเดียวกัน ⇒ เอกสารหน้าตาเหมือน FlowAccount ต้นฉบับ (ไม่มีโลโก้ FlowAccount ท้ายกระดาษ)
